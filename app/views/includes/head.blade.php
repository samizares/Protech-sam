<!-- Define Charset -->
  ...
  <meta name="description" content="Protech Gas Ltd - Hospital Supplies">
  ...
  <!-- Color CSS Styles  -->
  <link rel="stylesheet" type="text/css" href="{{asset('css/jade.css')}}" title="green" media="screen" />

  <link rel="stylesheet" type="text/css" href="{{asset('css/themes/flatty.css')}}" />
